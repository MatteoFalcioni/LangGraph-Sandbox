...
After installation, run the setup command to build the Docker image and create configuration files:
...
This command will:
- Copy Docker files (`Dockerfile`, `example.env`, `docker.env`) to your project directory
- Create a `.env` file from `example.env`
- Build the Docker image (`sandbox:latest`)
